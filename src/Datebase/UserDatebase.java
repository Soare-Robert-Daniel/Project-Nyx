...
*/
    ...
    public ResultSet getUsers() throws Exception
    {
        try {
            ...
            // Result set get the result of the SQL query
            resultSet = statement
                    .executeQuery("select * from datebase.users");
            return resultSet;
        } catch (Exception e) {
            throw e;
        } finally {
    ...
    public void updateUser(String username, String password) throws Exception
    {
        try {
            ...
            preparedStatement = connect
                    .prepareStatement("UPDATE datebase.users SET password = (?) WHERE user = (?)");
            // "myuser, webpage, datum, summary, COMMENTS from feedback.comments");
            // Parameters start with 1
    ...
    public void registerUser(String username, String password) throws Exception
    {
        try {
            ...
            preparedStatement = connect
                    .prepareStatement("insert into  datebase.users values (?, ?)");
            // "myuser, webpage, datum, summary, COMMENTS from feedback.comments");
            // Parameters start with 1
